...
const jobsData = [
  ...
  //   description: [
  //     "We are building a modular Customer Relationship Management (CRM) and automation platform designed to be reusable across multiple clients.The system includes core CRM modules, segmentation, workflow automation, and a built-in email campaign engine. You will work closely with the Lead System Architect and collaborate with frontend and full stack developers to implement backend features and business logic."
  //   ],
  //   responsibilities: [
